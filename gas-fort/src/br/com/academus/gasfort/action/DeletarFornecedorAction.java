...
public class DeletarFornecedorAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (usuario == null) {
...

			{
				...
				Fornecedor fornecedor = daoDao.loadFornecedor(Long.parseLong(idFornecedor));
				daoDao.deleta(fornecedor);
				
				Boolean deletaFornecedor = daoDao.verificaCliente(Long.parseLong(idFornecedor));
				httpSession.setAttribute("deletaFornecedor", deletaFornecedor);
