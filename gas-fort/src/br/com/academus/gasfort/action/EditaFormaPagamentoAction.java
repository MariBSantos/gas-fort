...
public class EditaFormaPagamentoAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		FormaPagamento formaPagamentoAtual = daoDao.loadFormaPagamento(formulario.getId());
		...
		daoDao.atualiza(formaPagamentoAtual);
